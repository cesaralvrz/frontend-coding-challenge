<template>
  <div
    class="container mx-auto p-6 text-gray-800 min-h-screen flex items-center justify-center w-full"
  >
    ...
    >
      ...
      <div class="mt-10 flex justify-center">
        <button
          @click="handleReturn"
          class="bg-teal-500 text-white px-8 py-3 rounded-lg hover:bg-teal-600 transition-all duration-200 transform hover:scale-105 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50 cursor-pointer"
        >
